    ...
    <div>
        <div class="max-w-sm rounded overflow-hidden shadow-lg border-t-4 border-blue p-4">
            ...
            <div class="flex justify-between mt-2">
                <div>
                        <!-- <p class="text-sm text-gray-500">Project Leads</p>
                        <b-avatar rounded="sm" text="VK" size="sm" class="mr-1 bg-orange-500"></b-avatar>
                        <b-avatar rounded="sm" text="AH" size="sm"></b-avatar> -->
                        <div class="text-xs text-hairline text-gray-600 mt-2 flex align-middle">
                            ...
                            <div>
                                {{ moment(data.ts/1000).format('MMMM Do YYYY') }}
                            </div>
                        </div>
                </div>
